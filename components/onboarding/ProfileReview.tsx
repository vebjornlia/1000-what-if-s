...
import { getBoldnessBadge } from "@/lib/utils/boldness";
...
export default function ProfileReview({
  ...
  const boldnessBadge = getBoldnessBadge(profile.boldness_level);
      ...
      <div className="rounded-2xl border border-border bg-white p-6 space-y-5">
        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            <span className={`inline-block rounded-full px-3 py-1 text-xs font-semibold ${boldnessBadge.className}`}>
              {boldnessBadge.label}
            </span>
          </div>
        </div>
