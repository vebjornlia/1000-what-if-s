...
import { boldnessBadge } from "@/lib/utils/boldnessBadge";
...
export default function ProfileReview({
  ...
  const boldness = boldnessBadge(profile.boldness_level);
      ...
      <div className="rounded-2xl border border-border bg-white p-6 space-y-5">
        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            <span className={`inline-block rounded-full px-3 py-1 text-xs font-semibold ${boldness.className}`}>
              {boldness.label}
            </span>
          </div>
        </div>
