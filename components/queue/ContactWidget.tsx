...
import { confidenceBadgeClass, confidenceLabel } from "@/lib/utils/confidenceBadge";
    ...
    return (
      <div className="mt-1">
        <div className="flex items-center gap-1.5">
          ...
          <span
            className={`rounded-full px-1.5 py-0.5 text-[9px] font-semibold ${confidenceBadgeClass(
              ...
              <div className="mt-1 space-y-1">
                {candidates.slice(1).map((c: DiscoveredEmail, i: number) => (
                  ...
                  >
                    ...
                    <span
                      className={`rounded-full px-1 py-0.5 text-[8px] font-semibold ${confidenceBadgeClass(
                        c.confidence
                      )}`}
                    >
