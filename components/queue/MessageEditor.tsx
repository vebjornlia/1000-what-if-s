...
export default function MessageEditor({
  ...
  // The contact the editor opens with. We only report a contact back on save
  // when the user actually changed it — otherwise saving a body/subject edit
  // would clobber the AI-discovered `resolved_contact` and force the discovery
  // status to "manual" (losing confidence/candidates, or writing a non-email
  // URL into the send address).
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl">
        ...
        <div className="mt-4 flex gap-2 justify-end">
          ...
          <button
            onClick={() => onSave(body, subject, to === initialTo ? undefined : to)}
